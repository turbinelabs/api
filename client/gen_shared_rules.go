...
func NewSharedRulesV1(
	...
	return &httpSharedRulesV1{dest, tbnhttp.NewRequestHandler(client, apiKey, apiClientID)}, nil
}
...
func (hc *httpSharedRulesV1) get(path string, params tbnhttp.Params) (*http.Request, error) {
...
func (hc *httpSharedRulesV1) delete(path string, params tbnhttp.Params) (*http.Request, error) {
